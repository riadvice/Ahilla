...
package com.alkiteb.ahilla.time
{
    ...
    public class Calendar implements ICalendar
    {
        ...
        /*---------------------------------------------*/
        // Add a time period to a Date value.
        public function addMonths( time : Date, months : int ) : Date
        {
            return null
        }
        ;

        public function addYears( time : Date, years : int ) : Date
        {
            return null
        }
        ;
        ...
        // Extract the components from a Date value.
        public function getDayOfMonth( time : Date ) : int
        {
            return NaN
        }
        ;

        public function getDayOfWeek( time : Date ) : int
        {
            return NaN
        }
        ;

        public function getDayOfYear( time : Date ) : int
        {
            return NaN
        }
        ;

        public function getMonth( time : Date ) : int
        {
            return NaN
        }
        ;

        public function getYear( time : Date ) : int
        {
            return NaN
        }
        ;
        ...
        public function getEra( time : Date ) : int
        {
            return NaN
        }
        ;
