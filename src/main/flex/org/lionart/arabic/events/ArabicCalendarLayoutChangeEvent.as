...
package org.lionart.arabic.events
{
	 ...
	 */
	public class ArabicCalendarLayoutChangeEvent extends Event
	{
		 ...
		 *  @productversion Flex 3
		 */
		public function ArabicCalendarLayoutChangeEvent(type:String,
		...
		{
			return new ArabicCalendarLayoutChangeEvent(type, bubbles, cancelable,
