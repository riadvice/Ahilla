...
package org.lionart.arabic.calendar
{
    ...
    public class UmAlQuraCalendar extends Calendar
    {
        ...
        /* Constuctor                                  */
        /*---------------------------------------------*/
        public function UmAlQuraCalendar(dateTime : Date = null, year:* = null, month:* = null, 
            days:*=null, hours:*=null,minutes:*=null,seconds:*=null,ms:*=null)
        {
            super( this );
            hijri = new HijriCalendar(dateTime, year, month, days, hours, minutes, seconds, ms);
        ...
        {
            return hirji.addMonths( months, time );
        }

        override public function addYears( years : int, time : Date = null ) : Date
        {
            return hirji.addYears( years, time );
        }
