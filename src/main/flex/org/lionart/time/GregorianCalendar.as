...
package org.lionart.time
{
    ...
    public class GregorianCalendar extends Calendar
    {
         ...
         */
        public function GregorianCalendar(dateTime : Date = null, year:* = null, month:* = null, 
            days:*=null, hours:*=null,minutes:*=null,seconds:*=null,ms:*=null,
            gregorianCalendarType : int = GregorianCalendarTypes.LOCALIZED )
        {
            super( this );
            calendarType = gregorianCalendarType;
            if ( seconds )
            {
                _internalDate = seconds;
            }
            else if ( year )
            {
                _internalDate = new Date(year, month, days, hours, minutes, seconds, ms);
                addYears(year);
            }
        }
        ...
        override public function addWeeks( weeks : int, time : Date = null ) : Date
        {
            return super.addWeeks( weeks, time );
        }
