 ...
 *  @productversion Flex 3
 */
public class ArabicDateField extends ComboBase
                       ...
                       IFocusManagerComponent, IListItemRenderer
{
     ...
     *  @productversion Flex 3
     */
    public function ArabicDateField()
    {
        super();
		
		// This line was added to support styles.
		styleName = "arabicDateField";
     ...
     */
    private var _dropdown:ArabicDateChooser;
     ...
     *  @productversion Flex 3
     */
    public function get dropdown():ArabicDateChooser
    {
        return _dropdown;
    }
     ...
     */
    private var _dropdownFactory:IFactory = new ClassFactory(ArabicDateChooser);
     ...
     */
    private var _parseFunction:Function = ArabicDateField.stringToDate;
    ...
    {
        if (ArabicDateField.createAccessibilityImplementation != null)
            ArabicDateField.createAccessibilityImplementation(this);
    }
    ...
    private function displayDropdown(show:Boolean, triggerEvent:Event = null):void
    {
        ...
        if (show)
        {
            ...
            var dd:ArabicDateChooser = dropdown;
