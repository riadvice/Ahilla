package org.lionart.components
{
    ...
    import org.lionart.arabic.calendar.HijriCalendar;
    import org.lionart.events.IslamicCalendarLayoutChangeEvent;
    ...
    public class IslamicCalendarLayout extends UIComponent implements IFocusManagerComponent, IFontContextComponent
    {
         ...
         *  @productversion Flex 3
         */
        public function IslamicCalendarLayout()
        {
            super();
        ...
        private var _calendarClass : Class;

        public function set calendarClass( value : Class ) : void
        {
            _calendarClass = value;
        }

        public function get calendarClass() : Class
        {
            if ( !_calendarClass )
            {
                _calendarClass = HijriCalendar;
            }
         ...
         *  @private
         */
        private var lastSelectedDate : ICalendar;

        /**
         *  @private
         */
        private var rangeStartDate : ICalendar = null;
        ...
        public function set disabledRanges( value : Array ) : void
        {
            ...
            {
                if ( _disabledRanges[i] is ICalendar )
                {
                    disabledRangeMode[i] = 4;
                    // TODO
                    _disabledRanges[i] = new calendarClass(null, value[i].getFullYear(), value[i].getMonth(), value[i].getDate());
                }
         ...
         */
        private var _displayedMonth:int = (new calendarClass()).getMonth();
         ...
         *  Storage for the displayedYear property.
         */
        private var _displayedYear:int = (new calendarClass()).getYear();
        ...
        [Inspectable(category="General", defaultValue="1420")]
        ...
        public function set selectableRange(value:Object) : void
        {
            ...
            var todaysDate:ICalendar = new calendarClass();
            var todaysMonth:int = todaysDate.getMonth();
            var todaysYear:int = todaysDate.getYear();
            var callMonth:int;
            var callYear:int;

            if ( value is ICalendar )
            {
                selRangeMode = 4;

                _selectableRange = new calendarClass(null,value.getFullYear(),
                    value.getMonth(),
                    value.getDate());
        ...
        public function get selectedRanges() : Array
        {
            if ( _selectableRange )
            {
                switch ( selRangeMode )
                {
                    ...
                    case 4:
                    {
                        removeRangeFromSelection(null, _selectableRange as ICalendar);
                        removeRangeFromSelection(_selectableRange as ICalendar, null);
                        break;
                    }
                }
            }
            ...
            {
                var minDate:ICalendar = _selectedRanges[0].rangeStart;
                var maxDate:ICalendar = _selectedRanges[0].rangeEnd;
                ...
                {
                    var tempDate:ICalendar = minDate;

                    var dayOffset:int = _disabledDays[i] - tempDate.getDayOfWeek();
         ...
         *  @private
         */
        public function get selectedDate() : ICalendar
        {
         ...
         *  @private
         */
        public function set selectedDate(value:ICalendar) : void
        {
        ...
        */
        ...
        override protected function commitProperties() : void
        {
            ...
            if ( selectedMonthYearChanged )
            {
                ...
                var proposedDate:ICalendar = 
                    new calendarClass(null, _proposedDisplayedYear == -1 ? _displayedYear : _proposedDisplayedYear,
        ...
        mx_internal function setSelectedMonthAndYear(monthVal:int = -1, yearVal:int = -1) : void
        {
            ...
            var displayDate:ICalendar = null;
            ...
            var today:ICalendar = new calendarClass();
            var currentMonthContainsToday:Boolean = (today.getYear() == newYear && today.getMonth() == newMonth);

            // Set up the days (if any) in row 1 that come from the previous month.
            var previousMonth:int = Math.max(newMonth - 1,0);
            var previousMonthDate:ICalendar = new calendarClass(null, newYear, previousMonth, 1);
            dayNumber = getNumberOfDaysInMonth(previousMonthDate.getYear(), previousMonthDate.getMonth());
            rowIndex = 1;
            ...
            {
                var cellDate:ICalendar = new calendarClass(null,newYear, newMonth, dayNumber);
                ...
                if ( currentMonthContainsToday && (cellDate.getDayOfMonth() == today.getDayOfMonth()) && _showToday )
                {
                    todayRow = rowIndex;
            ...
            displayDate = new calendarClass(null, newYear, newMonth, 1);
        ...
        mx_internal function getOffsetOfMonth(year:int, month:int) : int
        {
            ...
            var first:ICalendar = new calendarClass(null, year, month, 1);
            var offset:int = first.getDayOfWeek() - _firstDayOfWeek;
        ...
        {
            var date : ICalendar = new calendarClass();
            return date.getDaysInMonthInEra(year, month, date.getEra());
        ...
        {
            var change:IslamicCalendarLayoutChangeEvent =
                new IslamicCalendarLayoutChangeEvent(IslamicCalendarLayoutChangeEvent.CHANGE);
         ...
         */
        mx_internal function isDateInRange(value:ICalendar, dateRange:Object, rangeMode:int, ignoreDay:Boolean = false) : Boolean
        {
            ...
            if ( dateRange )
            {
                if ( ignoreDay )
                {
                    ...
                    {
                        var startDate:ICalendar = dateRange.rangeStart;
                        dateRangeCopy.rangeStart = new calendarClass(null, startDate.getYear(), startDate.getMonth(), 1);
                    }
                    if ( dateRange.rangeEnd )
                    {
                        var endDate:ICalendar = dateRange.rangeEnd;

                        dateRangeCopy.rangeEnd = new calendarClass(null,endDate.getYear(), endDate.getMonth(), getNumberOfDaysInMonth(endDate.getYear(), endDate.getMonth()));
                    }
         ...
         */
        mx_internal function checkDateIsDisabled(value:ICalendar) : Boolean
        {
            if ( !value )
                return false;
            ...
            if ( _disabledDays.length > 0 )
            {
                ...
                {
                    if ( value.getDayOfWeek() == _disabledDays[i])
                        selectedDateIsDisabled = true;
                }
            }
         ...
         */
        mx_internal function addToSelected(newDate:ICalendar, range:Boolean = false) : void
        {
            ...
            if ( range == false )
            {
                ...
                _selectedRanges[selectedRangeCount].rangeStart =
                    new calendarClass(newDate.getNativeDate());
            ...
            else
            {
                ...
                {
                    _selectedRanges[0] = {};
                    _selectedRanges[0].rangeStart = new calendarClass(newDate.getNativeDate());
                }
                else
                {
                    ...
                    _selectedRanges[0].rangeStart = new calendarClass(rangeStartDate.getNativeDate());
                ...
                _selectedRanges[0].rangeEnd = new calendarClass(newDate.getNativeDate());
            }
        }
         ...
         */
        mx_internal function incrementDate(value:ICalendar, amount:int = 1) : ICalendar
        {
            // FIXME if incorrect
         ...
         */
        mx_internal function isSelected(newDate:ICalendar) : Boolean
        {
         ...
         */
        mx_internal function removeRangeFromSelection(startDate:ICalendar, endDate:ICalendar) : void
        {
            for ( var n:int = 0; n < selectedRangeCount; n++ )
            {
                ...
                switch ( s1 )
                {
                    ...
                    case 14:
                    {
                        var temp:ICalendar = _selectedRanges[n].rangeEnd;
        ...
        mx_internal function setSelectedIndicators() : void
        {
            ...
            {
                var cellDate:ICalendar = new calendarClass(null, displayedYear, displayedMonth, dayNumber);
                i = offset + dayNumber - 1;
                columnIndex = i % 7;
                rowIndex = 1 + Math.floor(i / 7);
        ...
        override protected function keyDownHandler(event:KeyboardEvent) : void
        {
            ...
            */
            ...
            // FIXME
            var date:int = lastSelectedDate ? lastSelectedDate.getDayOfMonth() : 1;
            ...
            */
            ...
            for ( var i:uint = 0; i < 31; i++ )
            {
                ...
                if ( selChanged )
                {
                    var newDate:ICalendar = new calendarClass(null, displayedYear, displayedMonth, date);
        ...
        private function mouseUpHandler(event:MouseEvent) : void
        {
            ...
            {
                // TODO
                var newDate:ICalendar = new calendarClass(null, displayedYear, displayedMonth, int(selCell.text));
