package org.lionart.components
{
     ...
     *  @productversion Flex 3
     */
    public class IslamicDateChooser extends UIComponent implements IFocusManagerComponent, IFontContextComponent
    {
         ...
         *  @productversion Flex 3
         */
        public function IslamicDateChooser()
        {
            super();
         ...
         */
        mx_internal var dateGrid : IslamicCalendarLayout;
        ...
        /**
         * @private
         * The calendar class to be used.
         */
        private var _calendarClass : Class;

        public function set calendarClass( value : Class ) : void
        {
            if ( !(new value() is ICalendar))
            {
                throw new Error( "clendarClass property is not org.lionart.time.ICalendar type " );
            }
        ...
        [Inspectable( arrayType="ICalendar" )]
         ...
         */
        private var _displayedMonth : int = ( new HijriCalendar()).getMonth();
         ...
         */
        private var _displayedYear : int = ( new HijriCalendar()).getYear();
         ...
         */
        private var _selectedDate : ICalendar;
        ...
        {
            _selectedDate = scrubTimeValue( value ) as ICalendar;
        ...
        {
            if ( IslamicDateChooser.createAccessibilityImplementation != null )
                IslamicDateChooser.createAccessibilityImplementation( this );
        }
        ...
        override protected function createChildren() : void
        {
            ...
            if ( !dateGrid )
            {
                dateGrid = new IslamicCalendarLayout();
                dateGrid.calendarClass = calendarClass;
                dateGrid.styleName = new StyleProxy( this, calendarLayoutStyleFilters );
                addChild( dateGrid );
                dateGrid.addEventListener( IslamicCalendarLayoutChangeEvent.CHANGE, dateGrid_changeHandler );
        ...
        mx_internal function scrubTimeValue( value : Object ) : Object
        {
            if ( value is ICalendar )
            {
                ...
                return new calendarClass(null, value.getYear(), value.getMonth(), value.getDayOfMonth());
            }
            else if ( value is Object )
            {
                ...
                if ( value.rangeStart )
                {
                    range.rangeStart = new calendarClass( null,value.rangeStart.getYear(), value.rangeStart.getMonth(), value.rangeStart.getDayOfMonth());
                }

                if ( value.rangeEnd )
                {
                    range.rangeEnd = new calendarClass( null,value.rangeEnd.getYear(), value.rangeEnd.getMonth(), value.rangeEnd.getDayOfMonth());
                }
                return range;
            }
            return null;
        ...
        private function upYearButton_buttonDownHandler( event : Event ) : void
        {
            ...
            {
//                var newDate : Object = IslamicCalendarLayout.getNewIncrementDate( displayedYear, displayedMonth, 1, 0 );
                var newDate : Object = IslamicCalendarLayout.getNewIncrementDate( displayedYear, displayedMonth, 1, 0 );
//                var testDate : Date = new Date( newDate.year, newDate.month, selectableRange.rangeEnd.getDate());
                var testDate : Date = new calendarClass(null, newDate.getYear(), newDate.getMonth(), selectableRange.rangeEnd.getDayOfMonth());
...
//                var testDate : Date = new Date( newDate.year, newDate.month, selectableRange.rangeStart.getDate());
                var testDate : Date = new calendarClass( null,newDate.getYear(), newDate.getMonth(), selectableRange.rangeStart.getDayOfMonth());
        ...
        private function fwdMonthButton_buttonDownHandler( event : Event ) : void
        {
            ...
            if (( selectableRange ) && ( dateGrid.selRangeMode == 1 || dateGrid.selRangeMode == 3 ))
            {
//                var newDate : Object = IslamicCalendarLayout.getNewIncrementDate( displayedYear, displayedMonth, 0, 1 );
                var newDate : Object = IslamicCalendarLayout.getNewIncrementDate( displayedYear, displayedMonth, 0, 1 );
//                var testDate : Date = new Date( newDate.year, newDate.month, selectableRange.rangeEnd.getDate());
                var testDate : Date = new calendarClass( null,newDate.getYear(), newDate.getMonth(), selectableRange.rangeEnd.getDayOfMonth());
...
//                var testDate : Date = new Date( newDate.year, newDate.month, selectableRange.rangeStart.getDate());
         ...
         *  @private
         */
        private function dateGrid_changeHandler( event : IslamicCalendarLayoutChangeEvent) : void
        {
            _selectedDate = IslamicCalendarLayout( event.target ).selectedDate;

            var e : IslamicCalendarLayoutChangeEvent = new IslamicCalendarLayoutChangeEvent( IslamicCalendarLayoutChangeEvent.CHANGE );
